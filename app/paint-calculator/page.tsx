...
export default function PaintCalculator() {
  ...
  return (
    <>
      <Head>
        <title>
          Paint Calculator | Wall Paint
          Estimator
        </title>

        <meta
          name="description"
          content="Free online paint calculator to estimate wall paint quantity for rooms, houses, and construction projects."
        />

        <meta
          name="keywords"
          content="paint calculator, wall paint calculator, room paint estimator, construction calculator, paint quantity calculator"
        />

        <link
          rel="canonical"
          href="https://yourdomain.com/paint-calculator"
        />
      </Head>
