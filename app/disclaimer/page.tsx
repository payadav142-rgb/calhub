...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://calhub.in/disclaimer",
  },
  openGraph: {
    title: "Disclaimer | CalHub",
    description:
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <div className="rounded-3xl bg-gradient-to-br from-orange-50 via-white to-amber-50 p-10 shadow-xl">
          ...
          <p className="mt-8 text-lg leading-8 text-gray-600">
            ...
            CalHub are intended for general informational and
          ...
          <p className="mt-4 leading-8 text-gray-600">
            ...
            accuracy, CalHub does not guarantee that all formulas,
            results, or estimations are free from errors or suitable
            for every project scenario.
          </p>
          ...
          <p className="mt-4 leading-8 text-gray-600">
            ...
            information obtained from this website. CalHub shall not
            be held liable for any losses, damages, delays, cost
            overruns, or construction issues resulting from the use of
            our calculators or content.
          </p>
          ...
          <p className="mt-4 leading-8 text-gray-600">
            ...
            notice. Continued use of CalHub signifies acceptance of
            any revised disclaimer terms.
          </p>
        </div>
      </section>
