    ...
    <main className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <section className="mx-auto max-w-2xl px-6 py-16">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            ...
            foundations, pathways, and driveway
            projects instantly.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="rounded-3xl bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8 shadow-xl transition-all duration-300 hover:shadow-2xl">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">
            ...
            multiplying project length, width,
            and depth.
          </p>
          ...
          <p className="mt-6 leading-8 text-gray-600">
            ...
            homeowners estimate gravel quantity
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="rounded-3xl bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8 shadow-xl transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="mt-6 space-y-4 text-lg text-gray-600">
            <p>
              1. Enter project length in feet.
            </p>

            <p>
              2. Enter project width in feet.
            </p>

            <p>
              3. Enter gravel depth in feet.
            </p>

            <p>
              4. Click the calculate button to
              instantly estimate gravel volume.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="rounded-3xl bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8 shadow-xl transition-all duration-300 hover:shadow-2xl">
          ...
          <p className="mt-6 leading-8 text-gray-600">
            Actual gravel quantity may vary
        ...
        <div className="mt-10 space-y-6">
          <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-amber-50 p-6 shadow-xl">
            ...
            <p className="mt-3 leading-7 text-gray-600">
              Gravel quantity depends on project
              dimensions and required depth.
              This calculator provides quick and
              accurate estimation.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-amber-50 p-6 shadow-xl">
            ...
            <p className="mt-3 leading-7 text-gray-600">
              ...
              foundations, pathways, and outdoor
